...
public class ZoomPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware, ZoomSDKAuthenticationListener {
    ...
    private EventChannel meetingStatusEventChannel;
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        channel = new MethodChannel(msg, "plugins.webcare/zoom_channel");
        channel.setMethodCallHandler(this);

        meetingStatusEventChannel = new EventChannel(msg, "plugins.webcare/zoom_event_stream");
                ...
                new ZoomSDKInitializeListener() {
                    ...
                    public void onZoomSDKInitializeResult(int errorCode, int internalErrorCode) {
                        ...
                        if (errorCode != ZoomError.ZOOM_ERROR_SUCCESS) {
                            result.error("ZoomSDK", "Failed to initialize Zoom SDK", response);
                            return;
                        }
                        ...
                        meetingStatusEventChannel.setStreamHandler(new StatusStreamHandler(meetingService));
    ...
    private void joinMeeting(MethodCall methodCall, MethodChannel.Result result) {
        ...
        ZoomSDK.getInstance()
                ...
                .setAutoConnectVoIPWhenJoinMeeting(true);

        ZoomSDK.getInstance()
                .getMeetingSettingsHelper()
                .setMuteMyMicrophoneWhenJoinMeeting(true);
    ...
    private void meetingStatus(MethodChannel.Result result) {
        ...
        if (meetingService == null) {
            result.error("MEETING_STATUS_UNKNOWN", "No status available", null);
            return;
        }
        ...
        result.success(Arrays.asList(status.name(), ""));
    }
