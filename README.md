...
Forked from [25LucasAnselmo/gr_zoom](https://github.com/25LucasAnselmo/gr_zoom)

## How to Configure Zoom SDK for android and iOS

### Android

- Take a look at the [Zoom SDK Documentation](https://developers.zoom.us/docs/meeting-sdk/android/get-started/install-sdk/) for Android.

- After you download the sdk zip file, extract
  
  - `mobilertc-android-studio/commonlib/commonlib.aar` to the package `android/libs` directory.
  - `mobilertc-android-studio/mobilertc` to the package `android/libs` directory.

- Android is now configured.

### iOS

- Take a look at the [Zoom SDK Documentation](https://developers.zoom.us/docs/meeting-sdk/ios/get-started/install-sdk/) for iOS.

- After you download the sdk zip file, extract
  
  - `lib/MobileRTCScreenShare.xcframework` to the package `ios` directory.
  - `lib/MobileRTC.xcframework` to the package `ios` directory.
  - `lib/MobileRTCResources.bundle` to the package `ios` directory.

- iOS is now configured.
